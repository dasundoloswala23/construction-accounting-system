...
import { Plus, Landmark, TrendingUp, TrendingDown, Pencil, Trash2 } from 'lucide-react'
    ...
    <div className="space-y-4">
      ...
      <Card className="flex flex-wrap items-center gap-8 p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-xs uppercase tracking-wide text-[var(--text-muted)]">Total Balance</div>
