...
/** Values are in millions of LKR (matches the mocked/aggregated data shape). */
  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <AreaChart data={data} margin={{ top: 8, right: 12, left: 0, bottom: 0 }}>
        ...
        <Area type="monotone" dataKey="expenses" name="Expenses" stroke="#dc2626" strokeWidth={2} fill="url(#expensesFill)" dot={false} />
        <Area type="monotone" dataKey="income" name="Income" stroke="#16a34a" strokeWidth={2} fill="url(#incomeFill)" dot={false} />
      </AreaChart>
    </ResponsiveContainer>
  )
}
